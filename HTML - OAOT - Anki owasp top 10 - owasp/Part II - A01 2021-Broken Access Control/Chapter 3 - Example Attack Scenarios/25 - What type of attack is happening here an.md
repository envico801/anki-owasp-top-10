...
<!-- codeblock-start -->
<pre><code class="hljs language-plaintext"> https://example.com/app/getappInfo
...
FILE TAGS: #OWASP::#OWASP-Top-10::#Web-Security::#OAOT-Anki-owasp-top-10-owasp::#Part-II-A01-2021-Broken-Access-Control::#Chapter-3-Example-Attack-Scenarios::#25-What-type-of-attack-is-happening-here-an
